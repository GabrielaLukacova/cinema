...
if (isset($_POST['submit'])) {
    ...
    $query = $db->prepare("INSERT INTO Movie (title, genre, runtime, language, ageRating, description, imagePath, tagType) 
                           VALUES (:title, :genre, :runtime, :language, :ageRating, :description, :imagePath, :tagType)");
